            <div class="holder-image d-flex justify-content-center align-items-center">
                <div class="box shadow">
                    ...
                    <a style="text-decoration: none; color:black;" href="<?=base_url('login')?>">
                        <h4 class="text-center pt-5 text-light">Already have an account? Log in</h4>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container pt-5">
        <div class="content-about d-flex justify-content-center p-5 shadow">

                <div class="aside-left pt-5 p-5">
