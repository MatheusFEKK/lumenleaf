    ...
    <div class="container d-flex justify-content-center brunswickGreen min-vw-100">
        <div class="d-flex flex-row options p-3 gap-5">
            <div class="d-flex align-items-center flex-column">
                <a class="btn dashboard-button border-0" href="{{route('home')}}"></a>
                <h6 class="titleColor">Dashboard</h6>
            </div>
            <div class="d-flex align-items-center flex-column">
                <a class="btn tasks-button border-0" href="{{route('tasks')}}"></a>
                <h6 class="titleColor">Tasks</h6>
            </div>
        </div>
    </div>
</div>